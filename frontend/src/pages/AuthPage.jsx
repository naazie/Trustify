    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50 px-4">
      ...
      >
        ...
        <div className="glass rounded-2xl p-8 shadow-xl border border-surface-200">
          ...
          <button
            onClick={googleLogin}
            className="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border border-surface-300 bg-white hover:bg-surface-50 text-sm font-medium text-surface-700 transition-colors"
          >
